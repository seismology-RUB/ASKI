...
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - -
%
\subsection{\lcode{addSpikeCheckerToKim}} \label{programs_scripts,sec:bin_prog,sec:addSpikeCheckerToKim}
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
\lcode{template/createMeasuredData_parfile_txt_template} .
...
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - -
%
\subsection{\lcode{createSpectralFilters}} \label{programs_scripts,sec:bin_prog,sec:create_spec_filters}
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - -
Program exportKim produces a text file (option \lcode{-otxt}) containing information of cell centers and radii 
...
\end{itemize} 
where \lcode{c1,c2,c3} are the 3 coordinates of the cell center (in wavefield point coords), \lcode{r} 
...
ends on \lcode{nnb=0}). Then \lcode{number_of_parameters} blocks are following in the file, each having 
...
is an vector of the actual \lcode{nval} model values (space separated on one line).\\
\\
