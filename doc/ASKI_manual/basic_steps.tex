...
\myaref{programs_scripts,sec:bin_prog,sec:create_startmod_kim}. Option \lcode{-otxt} of this executable will
export the model in a text-based file format (as described in \myref{files,sec:text-kim_files}) 
...
(file format as described in \myref{files,sec:text-kim_files}), 
