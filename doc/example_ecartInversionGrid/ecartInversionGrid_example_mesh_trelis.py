...
#----------------------------------------------------------------------------
#   Copyright 2016 Florian Schumacher, Marcel Paffrath (Ruhr-Universitaet Bochum, Germany)
#
...
# the example ecart inversion grid as shown in the ASKI manual (ASKI version 1.2)
...
cubit.cmd('surface 22 12 18 19 20 21 size 7')
