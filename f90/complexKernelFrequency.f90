...
!
    ...
    case default
       ! Actually this case should not be called at all! This (and the above) routines are private
       ! and so if this module is consistent, this function getComplexKernelFrequency should only
       ! be called if methodHasComplexKernelFrequency(method) == .true.
       ! Just to be sure, return the real-valued conventional frequency in this case. 
       f = cmplx( df*jf )
    end select
